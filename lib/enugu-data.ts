...
export const enuguHotels: Place[] = [
  ...
  },
  {
    ...
    rooms: [
      {
        name: "Standard Suite",
        pricePerNight: 33_000,
        formattedPrice: "₦33,000/night",
        maxOccupancy: 2,
