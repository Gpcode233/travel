...
export const PLACE_COORDINATES: Record<string, { lat: number; lng: number; area?: string }> = {
  ...
  "hotel-new-york": { lat: 6.436, lng: 7.534, area: "Independence Layout" },
...
const HOTEL_POOL: AccommodationOption[] = [
  ...
  },
  {
    ...
    badge: "ALTERNATIVE",
    isSelected: false,
    amenities: ["Restaurant", "Bar", "Event space", "Free Wi-Fi", "Breakfast"],
    description: "City-style premium hotel in Independence Layout with modern rooms and event space.",
    recommendationReason: "Modern, city-inspired stay close to Enugu's main business and dining strip.",
  },
  {
    id: "acc-presidential",
